...
public class MainWordAdapter extends ArrayAdapter<Word> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(position == 0 || position == 5)  listItemView.setBackgroundResource(R.color.numbers_background);
        if(position == 1 || position == 6)  listItemView.setBackgroundResource(R.color.colors_background);
        if(position == 2 || position == 7)  listItemView.setBackgroundResource(R.color.inside_background);
